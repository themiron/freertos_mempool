...
extern void vAssertCalled(const char * const file, unsigned long line, const char * const func);
#define configASSERT( x ) if( ( x ) == 0 ) vAssertCalled( __FILE__, __LINE__, __func__)
